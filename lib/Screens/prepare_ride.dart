...
import 'package:easyride_app/widgets/endpoints_card.dart';
import 'package:easyride_app/widgets/search_listview.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Easy Ride'),
        actions: const [
          CircleAvatar(backgroundImage: AssetImage('assests/image/person.jpg')),
        ],
      ),
      body: SafeArea(
